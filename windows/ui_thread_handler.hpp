...
{
public:
    explicit UiThreadHandler(flutter::PluginRegistrarWindows *registrar)
    ...
    UiThreadHandler(const UiThreadHandler &) = delete;
    UiThreadHandler &operator=(const UiThreadHandler &) = delete;
